...
<div className="site-mobile-menu">
   ...
   <nav className="site-nav mb-5">
      ...
      <div className="container">
        <div className="row align-items-center">
          ...
          <div className="col-6 col-lg-9">
            ...
            <a href="/" className="small mr-3"><span className="icon-phone mr-2"></span> <span className="d-none d-lg-inline-block">+91 9992255369</span></a> 
            <a href="info@scopeindia.org" className="small mr-3"><span className="icon-envelope mr-2"></span> <span className="d-none d-lg-inline-block">info@scopeindia.org</span></a> 
          </div>
    ...
    <div className="untree_co-hero overlay" style={{ backgroundImage: `url('assets/images/hero-img-1-min.jpg')`}}>
<div className="container">
      <div className="row align-items-center justify-content-center">
        <div className="col-12">
         <div className="row justify-content-center ">
             <div className="col-lg-6 text-center ">
              <a href="https://vimeo.com/342333493" data-fancybox data-aos="fade-up" data-aos-delay="0" className="caption mb-4 d-inline-block">Watch the video</a>
...
<div className="untree_co-section">
      ...
      <div className="row">
        <div className="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div className="custom-media">
            <a href="/"><img src="assets/images/img-school-1-min.jpg" alt="Img" className="img-fluid"/></a>
        ...
        <div className="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div className="custom-media">
            <a href="/"><img src="assets/images/img-school-2-min.jpg" alt="Img" className="img-fluid"/></a>
            <div className="custom-media-body">
              <div className="d-flex justify-content-between pb-3">
                <div className="text-primary"><span className="uil uil-book-open"></span> <span>43 lesson</span></div>
                <div className="review"><span className="icon-star"></span> <span>4.8</span></div>
        ...
        <div className="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div className="custom-media">
            <a href="/"><img src="assets/images/img-school-3-min.jpg" alt="Img" className="img-fluid"/></a>
            <div className="custom-media-body">
              <div className="d-flex justify-content-between pb-3">
                <div className="text-primary"><span className="uil uil-book-open"></span> <span>43 lesson</span></div>
                <div className="review"><span className="icon-star"></span> <span>4.8</span></div>
  ...
  <div className="untree_co-section pt-0 bg-img overlay" style={{ backgroundImage: `url('assets/images/img-school-1-min.jpg')`}}>

    <div className="container">
      <div className="row align-items-center justify-content-center text-center">
        <div className="col-lg-7">
          <h2 className="text-white mb-3" data-aos="fade-up" data-aos-delay="0">Education for Tomorrow's Leaders</h2>
          <p className="text-white h5 mb-4" data-aos="fade-up" data-aos-delay="100">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
          <p><a href="/" className="btn btn-secondary" data-aos="fade-up" data-aos-delay="200">Enroll Now</a></p>
        </div>
      </div>
    </div>  
  </div> 
      ...
      <div className="row justify-content-between">
        ...
        <div className="col-lg-6" data-aos="fade-up" data-aos-delay="400">
          ...
          <a href="https://vimeo.com/342333493" data-fancybox className="video-wrap">
            ...
            <img src="assets/images/img-school-4-min.jpg" alt="Img" className="img-fluid rounded"/>
          </a>
        </div>
      </div>
    </div>
      ...
      <div className="row align-items-stretch">
        <div className="col-lg-6"  data-aos="fade-up" data-aos-delay="100">
          <div className="media-h d-flex h-100">
            <figure>
              <img src="assets/images/img-school-1-min.jpg" alt="Img"/>
            </figure>
            <div className="media-h-body">
              <h2 className="mb-3"><a href="/">Education for Tomorrow's Leaders</a></h2>
        ...
        <div className="col-lg-6"  data-aos="fade-up" data-aos-delay="200">
          <div className="media-h d-flex h-100">
            <figure>
              <img src="assets/images/img-school-2-min.jpg" alt="Img"/>
            </figure>
            <div className="media-h-body">
              <h2 className="mb-3"><a href="/">Enroll Your Kids This Summer to get 30% off</a></h2>
              <div className="meta mb-2"><span className="icon-calendar mr-2"></span><span>June 22, 2020</span>  <span className="icon-person mr-2"></span>Admin</div>
              <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
              <p><a href="/">Learn More</a></p>
            </div>
      ...
      <div className="row">
        <div className="col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="00">
          <div className="pricing">
           <div className="pricing-img mb-4"><img src="assets/images/1x/asset-1.png" alt="Img" className="img-fluid"/></div>
        ...
        <div className="col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="200">
          <div className="pricing">
           <div className="pricing-img mb-4"><img src="assets/images/1x/asset-2.png" alt="Img" className="img-fluid"/></div> 
            <div className="pricing-body">
        ...
        <div className="col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="300">
          <div className="pricing">
           <div className="pricing-img mb-4"><img src="assets/images/1x/asset-3.png" alt="Img" className="img-fluid"/></div> 
            <div className="pricing-body">
    ...
    <div className="container">
      ...
      <div className="row mt-5">
        <div className="col-12 text-center">
          <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script>. All Rights Reserved. &mdash; Designed with love by <a href="https://untree.co">Untree.co</a>  Distributed By <a href="https://themewagon.com">ThemeWagon</a> </p>
          </div>
        </div>
      </div>
    </div> 
